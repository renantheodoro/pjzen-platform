...
const apiServiceTitle = "UPDATE TAKER BY cpfCnpj";

module.exports = {
  async getCurrentTaker(cpfCnpj) {
  ...
  async call(takerData) {
    const { cpfCnpj, address, businessName, phone, email } = takerData;

    try {
      // const currentTakerData = await module.exports.getCurrentTaker(cpfCnpj);
