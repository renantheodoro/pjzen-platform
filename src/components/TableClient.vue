<template>
  <div :class="`card table-section table-section--client`">
    <div v-if="!removeHeader" class="table-section__header">
      ...
      <div class="width-full flex-v-center flex-between">
        ...
        <button
          v-if="!removeFilter"
          @click.prevent="$emit('onFilterClick')"
    ...
    <div class="table-section__body">
      ...
      <div v-if="!tableContent.body.length">
        Não foram encontrados clientes para serem exibidas.
      </div>
          ...
          >
            ...
            <td class="text-right">
              <Dropdown>
                ...
                <li>
                  <a @click.prevent="$emit('onEditProfile', bodyIndex)">
